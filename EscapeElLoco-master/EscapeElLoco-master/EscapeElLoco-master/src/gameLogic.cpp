...
void GameLogic::extractMap()
{
	...
	if (!levelMap.good()) {
		string absPath = "C:/GameProjects/EscapeElLoco/x64/Debug/" + filename;
		levelMap.open(absPath.c_str());
	}
	if (!levelMap.good()) {
		string absPath = "C:/Users/MSI/Downloads/EscapeElLoco-master/EscapeElLoco-master/" + filename;
		levelMap.open(absPath.c_str());
	}
	if (!levelMap.good()) {
		string absPath = "C:/GameProjects/EscapeElLoco/x64/Debug/" + filename;
